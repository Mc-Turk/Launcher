...
<i>{ProductName} {ProductVersion}</i>
                ...
                newsBrowser.Navigate("http://localhost/launcher");
        ...
        {
            Process.Start(@"https://github.com/Mc-Turk/Launcher/wiki/");
        }
        ...
        private void CheckLauncherUpdates()
        {
            ...
            try {
                ...
                GitHubRelease latest = JsonConvert.DeserializeObject<GitHubRelease>(wc.DownloadString(new Uri("https://api.github.com/repos/Mc-Turk/Launcher/releases/latest")));
